...
const updateTilt = (e) => {
    ...
    // Apply the tilt and dynamic shadow with the color #995bb6
    requestAnimationFrame(() => {
        tiltBox.style.transform = `rotateX(${tiltX}deg) rotateY(${tiltY}deg)`;
        tiltBox.style.boxShadow = `${-shadowX}px ${-shadowY}px ${shadowBlur}px #995bb6`; // Apply purple shadow
    });
};
...
document.addEventListener('mouseleave', () => {
    ...
    tiltBox.style.boxShadow = '0px 4px 4px #995bb6'; // Reset shadow with the same color
});
